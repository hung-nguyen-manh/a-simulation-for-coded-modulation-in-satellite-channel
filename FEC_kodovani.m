...
if onldpc == 1
    set(handles.text5,'Enable','on','String','Probìhlo');
else
end
if onprokladani == 1
...
% hObject    handle to Zavøít okno FEC (see GCBO)
close;

% --- Executes on selection change in popupmenu1.
function popupmenu1_Callback(hObject, eventdata, handles)
% hObject    handle to Vyber délku rámce (see GCBO)
...
% hObject    handle to Vyber kódový pomìr (see GCBO)
