...
kodovy_pomer=1;
msgboxText{1} = 'Zmìnili jste konstelaèní diagram, kódový rámec se mohl zmìnit';
msgbox(msgboxText,'Zmìnili jste konstelaèní diagram, kódový rámec se mohl zmìnit','warn');
